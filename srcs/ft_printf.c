...
int main()
{
	...
	int	*tab2 = malloc(0);
 	...
 	ft_printf("--------------------%%s--------------------\n");
	printf("00) standart PRINTF : |%09s|\n", "s_hidden");
	ft_printf("00) my       PRINTF : |%09s|\n", "s_hidden");
	...
	free(tab2);
	ft_printf("--------------------%%i--------------------\n");
	printf("01) standart PRINTF : |this %i number|\n", 0);
	ft_printf("01) my       PRINTF : |this %i number|\n", 0);
	printf("02) standart PRINTF : |%i|\n", 0);
	ft_printf("02) my       PRINTF : |%i|\n", 0);
	printf("03) standart PRINTF : |%3i|\n", 0);
	ft_printf("03) my       PRINTF : |%3i|\n", 0);
	printf("04) standart PRINTF : |%-3i|\n", 0);
	ft_printf("04) my       PRINTF : |%-3i|\n", 0);
	printf("05) standart PRINTF : |%8.3i|\n", 8375);
	ft_printf("05) my       PRINTF : |%8.3i|\n", 8375);
	printf("06) standart PRINTF : |%8.3i|\n", -8473);
	ft_printf("06) my       PRINTF : |%8.3i|\n", -8473);
	printf("07) standart PRINTF : |%-8.5i|\n", 34);
	ft_printf("07) my       PRINTF : |%-8.5i|\n", 34);
	printf("08) standart PRINTF : |%-8.5i|\n", 0);
	ft_printf("08) my       PRINTF : |%-8.5i|\n", 0);
	printf("09) standart PRINTF : |%-8.3i|\n", 8375);
	ft_printf("09) my       PRINTF : |%-8.3i|\n", 8375);
	printf("10) standart PRINTF : |%-8.3i|\n", -8473);
	ft_printf("10) my       PRINTF : |%-8.3i|\n", -8473);
	printf("11) standart PRINTF : |%-3.7i|\n", 3267);
	ft_printf("11) my       PRINTF : |%-3.7i|\n", 3267);
	printf("12) standart PRINTF : |%08.3i|\n", 8375);
	ft_printf("12) my       PRINTF : |%08.3i|\n", 8375);
	printf("13) standart PRINTF : |%08.3i|\n", -8473);
	ft_printf("13) my       PRINTF : |%08.3i|\n", -8473);
	printf("14) standart PRINTF : |%0-8.5i|\n", 34);
	ft_printf("14) my       PRINTF : |%0-8.5i|\n", 34);
	printf("15) standart PRINTF : |%0-8.5i|\n", 0);
	ft_printf("15) my       PRINTF : |%0-8.5i|\n", 0);
	printf("16) standart PRINTF : |%0-8.3i|\n", 8375);
	ft_printf("16) my       PRINTF : |%0-8.3i|\n", 8375);
	printf("17) standart PRINTF : |%0-8.3i|\n", -8473);
	ft_printf("17) my       PRINTF : |%0-8.3i|\n", -8473);
	printf("18) standart PRINTF : |%0-3.7i|\n", 3267);
	ft_printf("18) my       PRINTF : |%0-3.7i|\n", 3267);
	printf("19) standart PRINTF : |%-5.0i|\n", 0);
	ft_printf("19) my       PRINTF : |%-5.0i|\n", 0);
	printf("20) standart PRINTF : |%-5.i|\n", 0);
	ft_printf("20) my       PRINTF : |%-5.i|\n", 0);
